...
object ApiClient {
//    4. Request base url belum ada data
    fun getInstance():ApiService{
        ...
        val builder = Retrofit.Builder().baseUrl("https://doa-doa-api-ahmadramadhan.fly.dev/").addConverterFactory(GsonConverterFactory.create()).client(mOkHttpClient).build()
